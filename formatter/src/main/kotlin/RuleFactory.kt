...
class AssignationValidListOfTokensRuleFactory(private val tokenListSpacingRule: TokenListSpacingRule) : RuleFactory<AssignationValidListOfTokens> {
...
class EnterBeforePrintlnRuleFactory(private val tokenListSpacingRule: TokenListSpacingRule) : RuleFactory<PrintlnValidListOfTokens> {
