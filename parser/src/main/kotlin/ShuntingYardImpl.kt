...
//            return IntNumberLiteralNode(numberToken.value())
//        }
...
//            when (token) {
//                is NumberLiteralToken -> stack.add(IntNumberLiteralNode(token.value))
//                is OperatorHighToken -> stack.add(OperationNode(stack.removeLast(), token.tokenName.name, stack.removeLast() as IntNumberLiteralNode))
//            }
//        }
